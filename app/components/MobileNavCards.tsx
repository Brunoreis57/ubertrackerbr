    ...
    <div className="grid grid-cols-2 gap-4 sm:hidden">
      {links.map((link) => (
        <Link
          key={link.href}
          href={link.href}
          className={`${link.cor} p-4 rounded-lg shadow-md flex flex-col items-center justify-center text-center transition-transform hover:scale-105 dark:text-white text-gray-800 border border-transparent dark:border-gray-700`}
        >
