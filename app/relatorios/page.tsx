...
const RelatoriosPage = () => {
  ...
  const renderizarCardIndicador = (
    ...
    return (
      <div className={`${corFundo} rounded-lg shadow-lg p-4 flex flex-col hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700`}>
      ...
      {carregando ? (
        ...
        <>
          ...
          {resumos ? (
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  ...
                  {renderizarCardIndicador(
                    ...
                    'bg-blue-50 dark:bg-blue-800 border border-gray-200 dark:border-gray-700'
                  )}
                  {renderizarCardIndicador(
                    'Ganho Bruto',
                    ...
                    'bg-green-50 dark:bg-green-800 border border-gray-200 dark:border-gray-700'
                  )}
                  {renderizarCardIndicador(
                    'Gasto com Gasolina',
                    ...
                    'bg-red-50 dark:bg-red-800 border border-gray-200 dark:border-gray-700'
                  )}
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-gray-800 mb-2 dark:text-gray-200">Distância Média</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-gray-800 mb-2 dark:text-gray-200">Gasto Médio</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-gray-800 mb-2 dark:text-gray-200">Ganho por Hora</h3>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-yellow-800 shadow-md dark:bg-yellow-800 dark:border-yellow-700 dark:text-yellow-100">
          ...
          {!configVeiculo && (
            <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-yellow-800 shadow-md dark:bg-yellow-800 dark:border-yellow-700 dark:text-yellow-100">
              <p className="font-medium">Configurações do veículo não encontradas.</p>
              <p>
                Algumas estatísticas podem não estar precisas. 
                <a href="/configuracoes" className="underline ml-1 font-medium text-yellow-900 dark:text-yellow-100">
                  Configurar veículo
                </a>
              </p>
            </div>
